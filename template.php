 ...
 */
function sobellrhodes_theme_preprocess_page(&$vars, $hook) {
...
function sobellrhodes_theme_webform_grid($element) {
  $rows = array();
 ...
 */
function sobellrhodes_theme_breadcrumb($breadcrumb) {
 ...
 */
function sobellrhodes_theme_menu_local_tasks() {
  $output = '';
...
/**
 * sobellrhodes_theme_preprocess_search_theme_form().
 */
function sobellrhodes_theme_preprocess_search_theme_form(&$vars, $hook) {
 ...
 */
function sobellrhodes_theme_form_element($element, $value) {
 ...
 */
function sobellrhodes_theme_textfield($element) {
 ...
 * Override theme_textfield().
 */
function sobellrhodes_theme_webform_email($element) {
  // Add bootstrap classes
  $class = array('form-control');
 ...
 */
function sobellrhodes_theme_textarea($element) {
 ...
 */
function sobellrhodes_theme_password($element) {
 ...
 */
function sobellrhodes_theme_select($element) {
 ...
 */
function sobellrhodes_theme_checkbox($element) {
